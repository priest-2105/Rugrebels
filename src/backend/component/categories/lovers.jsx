        ...
        return (
          ...
          <div className="container" style={{marginTop:"150px"}}>
                    ...
                    <div className="section-header product-list-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{marginTop:"100px",maxWidth:"500px"}}>
                                <h1 className="d-lg-display-5 text-primary mb-3">Our lovers Products</h1>
                    ...
                    {/* <select
                        ...
                        className="form-control ms-auto mb-2 col-2 d-sm-none d-xs-none"
                    >
                    ...
                    marginLeft:'auto',
                        ...
                        <div className="row g-4 col-lg-12 col-md-12 col-sm-12 col-xs-12 col bg-dark" style={{minHeight:"500px"}}>
                            ...
                            {displayedProducts
                            .filter((product) => product.category === "lovers")
                            .map((product) => {
                            ...
                            {displayedProducts.filter((product) => product.category === "bundle").length >= 1 &&
