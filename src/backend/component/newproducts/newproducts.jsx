        ...
        const fetchproducts = async () => {
          try {
            ...
            const productData = snapshot.docs.map((doc) => {
              ...
              product.isNew = daysDifference <= 7; // Change to 15 days
      
              return product;
            });
      
            // Filter products created within the last 15 days
            const filteredProducts = productData.filter(product => product.isNew);
    ...
    return (
        ...
        <div className="container-xxl position-relative">
              <div className="container">
                  <div className="section-header  text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth:"400px"}}>
                        <h1 className="d-lg-display-6  mb-3">Latest Products </h1>
                      </div>
                    <div className=" g-0 gx-5 align-items-start">
                    <div className="g-4 bg-light" style={{minHeight:"500px"}}>
                      ...
                      <div className="slick1"> */}
                        ...
                        {filteredProducts.map(product => {
                          ...
                          const productQuantity = selectedQuantities[productId] || 1;
                              ...
                              return (
                              <div className="col-xl-12 col-lg-12 bg-light position-relative col-md-12 wow fadeInUp" data-wow-delay="0.1s" key={product.id}>
