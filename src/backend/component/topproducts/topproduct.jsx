...
import 'react-toastify/dist/ReactToastify.css';
      ...
      useEffect(() => {
        const fetchProducts = async () => {
          try {
            ...
            // Filter products with amountsold above 50
            const filteredProducts = productData.filter(product => {
              const amountsold = parseInt(product.amountsold, 0); // Assuming amountsold can be a string or number
              return !isNaN(amountsold) && amountsold == 0;
            });
      
            // Limit the number of displayed products to 15
  ...
  const handleQuantityChange = (productId, quantity) => {
    ...
    return (
        ...
        <div className="container-xxl py-1 bg-dark position-relative" style={{marginTop:"50px"}}>
        <div className="container">
            <div className="section-header text-start bg-dark mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth:"500px"}}>
                        <h1 className="d-lg-display-5  text-light mb-3">Our Collection  </h1>
                    </div>
                     <div className=" g-0 gx-5 align-items-start">
                 <div className="g-5 bg-dark" style={{height:"600px"}}>
                 {/* <div className="wrap-slick1 rs2-slick1 ">
                    ...
                    <Slider {...settings}>
                        ...
                        const productQuantity = selectedQuantities[productId] || 1;
                            ...
                            <div className="col-xl-12 col-lg-12 py-4 bg-dark  text-light  position-relative col-md-12 wow fadeInUp" data-wow-delay="0.1s" key={product.id}>                       
                                <div className="product-item bg-black each-product-container text-light" style={{height:"100%"}}>
                                    ...
                                    <div className="text-start text-light p-4">
                                        <h6 style={{fontSize:"15px"}} className="d-block text-light product-item-title mb-2">{product.title}</h6>
                               ...
                               <a href={product.stripelink} className="text-body ms-auto me-1 text-primary text-light border-0 bg-transparent">
                                         <i class="bi bi-bag text-primary "></i>
                                        </a>
                                    </div>
                                 </div>
