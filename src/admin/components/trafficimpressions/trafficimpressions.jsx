...
const TrafficImpressionChart = () => {
    ...
    const filteredData = [10, 30, 40, 60, 70, 80, 90, 100, 110, 120, 130, 140]; // Example data, replace with actual data
        ...
        myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: filteredData,
                    backgroundColor: 'rgb(167, 213, 15,0.1)',
...
export default TrafficImpressionChart;
